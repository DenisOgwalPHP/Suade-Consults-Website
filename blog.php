	...
	<div class="agile-prod">
		<div class="container">
			<h3 class="wthree_head">Blog</h3>
				<p class="agileits_w3layouts_para w3_agile_para">Our blogs entails resources such as Environment and safety blogs,Articles,Guides,Infographic and Video library.</p>
		...
		<?php
			...
			echo"<div class='agile-prod1'>";
			echo"<div class='col-md-6 agile-img'>";
				echo"<img src='blogimg/".$row5['blogimage']."' alt='image' style='Height:600px; Width:100%'>";
			echo"</div>";
			echo"<div class='col-md-6 agile-sub'  style='Height:600px; Width:50%'>";
				echo"<h4>".$row5['blogtitle']."</h4>";
				echo"<p style='text-align:justify;text-justify: inter-word; font-size: 0.9em;'>".$row5['description']."</p>";
				if($_SESSION['suadeuser']=="Guest"){
				echo"<p style='text-align:justify;text-justify: inter-word;'>Attachment:<a href='typography.php'> Please Click here for login to download the attachment.</a></P>";
				}else{
				echo"<p style='text-align:justify;text-justify: inter-word;'>Attachment: <a href='blogattach/".$row5['attachment']."'>".$row5['attachment']."</a></p>";
				}
				echo"<p style='text-align:justify;text-justify: inter-word;'> Posted By: ".$row5['postedby']."</p>";
				echo"<p style='text-align:justify;text-justify: inter-word;'> Date: ".$row5['Date']."</p>";
			echo"</div>";
