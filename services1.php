...
<body>
	...
	<div class="agile-prod">
		<div class="container">
			<h3 class="wthree_head">Geospatial and data management Service</h3>
		...
		<div class="agile-prod1">
			<div class="col-md-6 agile-sub">
				<h4>Geospatial and data management </h4>
				<p style="text-align:justify;text-justify: inter-word;">Our GIS Department offers a range of services comprising of;</p>
					<ul>
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="#">Spatial data analysis </a></li>
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="#">Map processing</a></li>
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="#">Design</a></li>
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="#">Digitization.</a></li>
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="#">Geo-statistical analysis</a></li>
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="#">Remote Sensing techniques</a></li>
				</ul>
			</div>
