...
<body>
	...
	<div class="agile-prod">
		<div class="container">
			<h3 class="wthree_head">Environmental impact assessment Service</h3>
		...
		<div class="agile-prod1">
			<div class="col-md-6 agile-sub">
				...
				<p style="text-align:justify;text-justify: inter-word;">The company is involved in assessment of possible positive or negative impacts that a proposed project may have on the environment including the environmental, social and economic aspects. This is done to ensure that decision makers consider the ensuing environmental impacts when deciding whether or not to proceed with the project.</p>
					<ul>
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="#">Environmental Applications </a></li>
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="#">NEMA – Scoping & EIA, Basic Assessment,</a></li>
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="#">Screening Assessment</a></li>
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="#">Environmental Management Frameworks and Programs.</a></li>
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="#">Public Participation Coordination</a></li>
				</ul>
			</div>
