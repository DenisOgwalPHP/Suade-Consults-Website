...
<body>
	...
	<div class="agile-prod">
		<div class="container">
			<h3 class="wthree_head">Environmental monitoring and audits Service</h3>
		...
		<div class="agile-prod1">
			<div class="col-md-6 agile-sub">
				<h4>Environmental monitoring and audits </h4>
				<p style="text-align:justify;text-justify: inter-word;">The company does offer the service of environmental monitoring and audits. These are intended to identify environmental compliance and management system implementation gaps, along with related corrective and preventive actions.</p>
					
			</div>
			<div class="col-md-6 agile-img">
				<img src="images/g15.jpg" alt="image">
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
