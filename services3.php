...
<body>
	...
	<div class="agile-prod">
		<div class="container">
			<h3 class="wthree_head">Contamination assessment and remediation Service</h3>
		...
		<div class="agile-prod1">
			<div class="col-md-6 agile-sub">
				<h4>Contamination assessment and remediation </h4>
				<p style="text-align:justify;text-justify: inter-word;"> </p>
					<ul>
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="#">Remediation system design and contamination Clean-ups </a></li>
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="#">Project management and quality control of remediation systems</a></li>
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="#">Management of specialist remediation contractors</a></li>
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="#">Independent short- or long-term site subsurface monitoring</a></li>
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="#">Professional and independent advice and peer review</a></li>
					<li><i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="#">Liaison with the relevant authorities</a></li>
				</ul>
			</div>
			<div class="col-md-6 agile-img">
				<img src="images/g13.jpg" alt="image">
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
