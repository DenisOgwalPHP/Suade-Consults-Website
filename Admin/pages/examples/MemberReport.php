        ...
        <div class="row">
          <div class="col-12">
            <div class="callout callout-info">
              ...
              This page is a display of members registered with the system in A desceding way based on Order of registration, so you can print them accordingly.
            </div>
...
require_once('../../Connection/connect.php');
$dates1=date("Y");
$sales ="SELECT COUNT(IDDesc) as registration FROM `registration`";
...
?> 
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="MemberPrint.php" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
