...
// getting inputs from the form	
   $productname = $_POST['productname'];
	...
	$query = "INSERT INTO `productdetails` (ProductName,Supplier,Category,Cost,Description,ProductImage,ShortDescription,SubCategory) VALUES('$productname','$supplier','$category','$cost','$description','$newfilename','$shortdescription','$subcategories')";
