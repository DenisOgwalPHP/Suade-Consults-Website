        ...
        <div class="col-12">
          ...
          <div class="card" style='overflow-x:scroll'>
            <div class="card-header">
              <h3 class="card-title">Members Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
				...
				$sales6 ="SELECT FullNames,Email,Telephone,Address,created_at,MemberType,ApprovalStatus,IDDesc FROM `registration` order by IDDesc Desc";
				...
				while($row5=mysqli_fetch_assoc($result5)){
				 ...
				 echo "<td>".$row5['MemberType']."</td>";
				 $ApprovalStatus=$row5['ApprovalStatus'];
				  $id=$row5['IDDesc'];
					if($ApprovalStatus=='Not Approved'){
						echo'<td><form method="get" ><a href="MembersTable.php"><button type="submit" name="approve"  value="'.$id.'" class="btn btn-block btn-warning">Approve</button></a></form></td>'; 
					
					}else{				  
				  echo "<td>".$row5['ApprovalStatus']."</td>";
					}
					
				 echo'<td><form method="get" ><a href="MembersTable.php"><button type="submit" name="delete"  value="'.$id.'" class="btn btn-block btn-danger">Delete</button></a></form></td>';  
                echo"</tr>";
				}
				?>
				<?php
				...
				echo'alert("Member successfully Deleted");';
				echo'window.location.href="MembersTable.php";';
				echo '</script>';
							}else{
				echo '<script type="application/javascript">';
				echo'alert("Member Delete Failed");';
				//echo'alert("'.$id.'");';
				echo'window.location.href="MembersTable.php";';
				echo '</script>';
								}
				...
				if($result){
					echo '<script type="application/javascript">';
				echo'alert("Member Approval Successful");';
				echo'window.location.href="MembersTable.php";';
				echo '</script>';
				}else{
				echo '<script type="application/javascript">';
				echo'alert("Member approval Failed");';
				echo'window.location.href="MembersTable.php";';
				echo '</script>';
								}
				}
