...
<body>
	...
	<div class="typo">
		...
		<h3 class="wthree_head">User </h3>
				<p class="agileits_w3layouts_para w3_agile_para">Sign in if you alredy have an account with us, or Sign up if you don't.</p>
		
			<div class="grid_3 grid_4 w3layouts">
				<h3 class="hdg">Login</h3>
				<form action="login.php" method="POST">
				<div class="input-group w3_w3layouts">
				<span class="input-group-addon" id="basic-addon1">@</span>
				<input type="email" id="usernames" name="usernames" class="form-control" placeholder="Username/Email"  aria-describedby="basic-addon1" required />
				</div>
				<div class="input-group w3_w3layouts">
				<span class="input-group-addon" id="basic-addon1">...</span>
				<input type="password" id="Passwords" name="Passwords" class="form-control" placeholder="Password"  aria-describedby="basic-addon1" required />
				</div>
				<input type="submit" id="loginbutton" name="loginbutton" style="padding:10px; width:15%; background:#fb5710;color: #fff; font-size: 1.5em;text-transform: uppercase;" value="Login">
				</form>
			</div>
			...
			<div class="input-group input-group-lg w3_w3layouts">
				...
				<input type="email" id="usernames" name="usernames" class="form-control" placeholder="Username..." required aria-describedby="sizing-addon1">
			</div>
			<div class="input-group input-group-lg w3_w3layouts">
				<span class="input-group-addon" id="sizing-addon1">Password </span>
				<input  type="password" id="Passwords" name="Passwords" class="form-control" placeholder="password..." required aria-describedby="sizing-addon1">
			</div>	
			<div class="input-group input-group-lg w3_w3layouts">
				<span class="input-group-addon" id="sizing-addon1">Location</span>
				<input type="text" id="locations" name="locations" class="form-control" placeholder="Area of Residence..." required aria-describedby="sizing-addon1">
			</div>
			<div class="input-group input-group-lg w3_w3layouts">
				<span class="input-group-addon" id="sizing-addon1">Telephone</span>
				<input type="number" id="telephones" name="telephones" class="form-control" placeholder="Phone Number..." required aria-describedby="sizing-addon1">
			</div>
			<div class="input-group input-group-lg w3_w3layouts">
				<span class="input-group-addon" id="sizing-addon1">Full Names</span>
				<input type="text" id="fullnames" name="fullnames" class="form-control" placeholder="Your Full Names..."  required aria-describedby="sizing-addon1">
			</div>
			<input type="submit" id="registerbutton" name="registerbutton" style="padding:10px;  width:15%; background:#fb5710;color: #fff; font-size: 1.5em;text-transform: uppercase;" value="Register">
			</form>
