...
<body>
	...
	<div class="agileits_w3layouts_mail_grids">	
		<div class="col-md-7 w3l_mail_left">
			<div id="map"><img src="images/saudelocation.jpg" alt="" style="height:420px; width:100%"></img></div>
		</div>
		<div class="col-md-5 w3l_mail_right">
			<h3>Contact Info</h3>
			<ul>
				<li><span><i class="fa fa-home" aria-hidden="true"></i>Head Office<label>:</label></span>  Plot No. 22, Acacia Avenue, Kololo</li>
				<li><span><i class="fa fa-fax" aria-hidden="true"></i>Working Days<label>:</label></span> Mon-Fri: 8:00-5:30, Sat: 8:00-1:00pm</li>
				<li><span><i class="fa fa-phone" aria-hidden="true"></i>Phone<label>:</label></span> 0312-456-789</li>
				<li><span><i class="fa fa-envelope" aria-hidden="true"></i>Email<label>:</label></span> <a href="mailto:info@example.com">info@suadeconsults.co.ug</a></li>
	...
	<div class="banner-bottom">
		<div class="container">
			<h3 class="wthree_head">get in touch with us</h3>
				<p class="agileits_w3layouts_para w3_agile_para">Send Your Inquiries from here and we shall get back to you shortly through a phone call or Email.</p>
			<div class="agileinfo_mail_grids">
				<form action="mailing.php" method="post">
					...
					<span class="input input--chisato">
						<input class="input__field input__field--chisato" name="email" id="email" type="email" id="input-14" placeholder=" " required="" />
						<label class="input__label input__label--chisato" for="input-14">
							<span class="input__label-content input__label-content--chisato" data-content="Email">Email</span>
						</label>
					</span>
					<span class="input input--chisato">
						<input class="input__field input__field--chisato" name="phone" type="text" id="phone" placeholder=" " required="" />
						<label class="input__label input__label--chisato" for="input-15">
							<span class="input__label-content input__label-content--chisato" data-content="Subject">Subject</span>
						</label>
					</span>
					<textarea name="msg" id="msg" placeholder="Your comment here..." required=""></textarea>
